            ...
            <div className="container form-signin">
                ...
                <form onSubmit={props.onSubmit} className="">
                    <div className="form-group">
                        <input type="email" className="form-control" id="email" value={props.user.email} onChange={props.onChange} placeholder="Enter Any Email Address (eg.: email@example.com)"/>
                    </div>
